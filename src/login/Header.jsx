        ...
        <div className="container-xxl justify-content-lg-end">
          ...
          >
            <img
              ...
              alt="central gov logo"
              width="45"
            />
            <div className="lh-1 fs-6 fw-ligh ms-2 text-dark">
              <p className="m-0 text-white fw-bold mb-1 fs-7">
                Free Coaching Scheme For <br />
                SC & OBC Students{" "}
              </p>
              <p className="m-0 fs-7 text-white">
          ...
          <button
            className="navbar-toggler shadow-none px-2"
            type="button"
          ...
          >
            <ul className="navbar-nav me-auto my-lg-0 navbar-nav-scroll">
              <li className="nav-item">
                <NavLink
                  className="nav-link p-0 py-1 me-4 d-inline-block"
                  to="/"
                >
                  Home
                </NavLink>
              ...
              <li className="nav-item">
                <NavLink
                  className="nav-link p-0 py-1 me-0 d-inline-block"
                  to="/contact"
                >
                  Contact Us
                </NavLink>
            ...
            <NavLink
              to="/login"
              className="float-right btn bg-yellow rounded-pill py-2 px-4 fs-7 fw-bold"
            >
              Login
            </NavLink>
          </div>
