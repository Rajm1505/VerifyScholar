# Generated by Django 4.1 on 2022-08-15 15:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='family_income',
            fields=[
                ('sid', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('sid', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('aadhar', models.FileField(default=True, max_length=250, null=True, upload_to='')),
                ('incomecertificate', models.FileField(default=True, max_length=250, null=True, upload_to='')),
            ],
        ),
    ]
